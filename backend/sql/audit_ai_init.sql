...
CREATE TABLE `audit_ai_finding` (
  ...
  `quote_text` varchar(1000) DEFAULT '' COMMENT '报告原文引用',
...
(`finding_id`, `ai_task_id`, `finding_type`, `finding_title`, `finding_content`, `quote_text`, `page_no`, `location_json`, `sort_num`)
VALUES
(1, 1, '内容缺失', '内容缺失：委托单位联系人及联系方式未填写', '本次报告经AI核查，发现存在内容缺失、格式错误两类问题，具体已汇总如下，对应报告中相关标注位置，便于整改完善。', '委托单位联系人及联系方式：', 1, '{"page":1}', 1),
(2, 1, '格式错误', '格式错误：检测项目及结果未按规范设置表格标题', '本次报告经AI核查，发现存在内容缺失、格式错误两类问题，具体已汇总如下，对应报告中相关标注位置，便于整改完善。', '检测项目及结果', 2, '{"page":2}', 2),
